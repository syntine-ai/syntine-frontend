...
const orgSearchItems = [
  {
    ...
    items: [
      ...
      { name: "Agents", route: "/agents", icon: Bot },
      { name: "Call Analytics", route: "/calls", icon: Phone },
      { name: "Settings", route: "/settings", icon: Settings },
      { name: "My Account", route: "/account", icon: User },
  ...
  },
  {
    category: "Campaigns",
    items: [
      { name: "Renewal Follow-Up", route: "/campaigns/1", icon: Megaphone },
      { name: "Lead Re-Activate", route: "/campaigns/2", icon: Megaphone },
      { name: "Summer Outreach 2024", route: "/campaigns/3", icon: Megaphone },
      { name: "Q4 Sales Push", route: "/campaigns/4", icon: Megaphone },
    ],
  },
  {
    category: "Agents",
    items: [
      { name: "Assistant A", route: "/agents/1", icon: Bot },
      { name: "Assistant B", route: "/agents/2", icon: Bot },
      { name: "Sales Bot Pro", route: "/agents/3", icon: Bot },
      { name: "Support Assistant", route: "/agents/4", icon: Bot },
    ],
  },
];
