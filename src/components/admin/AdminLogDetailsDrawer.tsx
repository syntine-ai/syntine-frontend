...
import type { AdminLogEntry } from "./AdminLogsTable";

interface AdminLogDetailsDrawerProps {
...
export const AdminLogDetailsDrawer = ({
  log,
  open,
  onOpenChange,
}: AdminLogDetailsDrawerProps) => {
                ...
                <div className="space-y-3">
                  ...
                  {log.orgId && (
                    <div className="flex items-center gap-3 text-sm">
                      ...
                      <code className="text-xs bg-admin-accent/10 text-admin-accent px-2 py-0.5 rounded font-mono">
                        {log.orgId}
                      </code>
                    </div>
                  )}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Textarea
                      ...
                      className="font-mono text-xs h-[180px] resize-none bg-muted/30"
                    />
                  </div>
                </div>
